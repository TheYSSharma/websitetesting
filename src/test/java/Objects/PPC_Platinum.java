...
public class PPC_Platinum {

	WebDriver driver; 
	CSVPrinter csvPrinter;
	public PPC_Platinum(WebDriver driver, CSVPrinter csvPrinter) {
		this.driver = driver;
		this.csvPrinter = csvPrinter;
	}

	By Ppcp = By.xpath("//img[@alt='AL FARDAN EXCHANGE']");

	public void Ppcp_Links() throws IOException {
		String url;
		int i = 1;
		int count = 1;
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));
		try {
			csvPrinter.printRecord("Links in PrePaid Card Platinum Page");
