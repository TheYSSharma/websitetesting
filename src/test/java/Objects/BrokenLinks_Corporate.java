...
public class BrokenLinks_Corporate {
	WebDriver driver; 
	CSVPrinter csvPrinter;
	public BrokenLinks_Corporate(WebDriver driver, CSVPrinter csvPrinter) {
		this.driver = driver;
		this.csvPrinter = csvPrinter;
	}

	By Corp = By.xpath("//img[@alt='AL FARDAN EXCHANGE']");

	public void Corp_Links() throws IOException {
		String url;
		int i = 1;
		int count = 1;
