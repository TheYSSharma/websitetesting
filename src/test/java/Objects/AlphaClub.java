...
public class AlphaClub {
	WebDriver driver; 
	CSVPrinter csvPrinter;
	public AlphaClub(WebDriver driver, CSVPrinter csvPrinter) {
		this.driver = driver;
		this.csvPrinter = csvPrinter;
	}

	By Apc = By.xpath("//img[@alt='AL FARDAN EXCHANGE']");

	public void Apc_Links() throws IOException {
		String url;
		int i = 1;
		int count = 1;
