...
public class BrokenLinks_Blog {
	WebDriver driver; 
	CSVPrinter csvPrinter;
	public BrokenLinks_Blog(WebDriver driver, CSVPrinter csvPrinter) {
		this.driver = driver;
		this.csvPrinter = csvPrinter;
	}

	By Blog = By.xpath("//img[@alt='AL FARDAN EXCHANGE']");

	public void Blog_Links() throws IOException {
		String url;
		int i = 1;
		int count = 1;
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));
		try {
			csvPrinter.printRecord("Links in Blog.");
