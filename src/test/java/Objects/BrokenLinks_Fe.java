...
public class BrokenLinks_Fe {

	WebDriver driver; 
	CSVPrinter csvPrinter;
	public BrokenLinks_Fe(WebDriver driver, CSVPrinter csvPrinter) {
		this.driver = driver;
		this.csvPrinter = csvPrinter;
	}

	By Fe = By.xpath("//img[@alt='AL FARDAN EXCHANGE']");

	public void FeLinks() throws IOException {
		String url;
		int i = 1;
		int count = 1;
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));
		try {
			csvPrinter.printRecord("Links in Foreign Exchange Page");
