...
public class BrokenLinksWU_MT {
	WebDriver driver; 
	CSVPrinter csvPrinter;
	public BrokenLinksWU_MT(WebDriver driver, CSVPrinter csvPrinter) {
		this.driver = driver;
		this.csvPrinter = csvPrinter;
	}

	By Wumt = By.xpath("//img[@alt='AL FARDAN EXCHANGE']");

	public void Wumt_Links() throws IOException {
		String url;
		int i = 1;
		int count = 1;
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));
		try {
			csvPrinter.printRecord("Links in Western Union Money Transfer.");
