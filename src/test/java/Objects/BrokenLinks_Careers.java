...
public class BrokenLinks_Careers {
	WebDriver driver; 
	CSVPrinter csvPrinter;
	public BrokenLinks_Careers(WebDriver driver, CSVPrinter csvPrinter) {
		this.driver = driver;
	...
	public void Career_Links() throws IOException {
		String url;
		int i = 1;
		int count = 1;
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));
		try {
			csvPrinter.printRecord("Links in Careers.");
