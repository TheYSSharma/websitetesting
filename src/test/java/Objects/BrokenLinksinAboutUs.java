...
public class BrokenLinksinAboutUs {
	WebDriver driver;
	CSVPrinter csvPrinter;

	public void BrokenLinksinExcel(WebDriver driver, CSVPrinter csvPrinter) {
		this.driver = driver;
		this.csvPrinter = csvPrinter;
	}

	By abtus = By.xpath("//img[@alt='AL FARDAN EXCHANGE']");

	public void AboutUSLinks() throws IOException {
		String url;
		int i = 1;
		int count = 1;
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));
		try {
			csvPrinter.printRecord("Links in About Us Page");
