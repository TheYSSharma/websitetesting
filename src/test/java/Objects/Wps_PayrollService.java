...
public class Wps_PayrollService {
	WebDriver driver; 
	CSVPrinter csvPrinter;
	public Wps_PayrollService(WebDriver driver, CSVPrinter csvPrinter) {
		this.driver = driver;
		this.csvPrinter = csvPrinter;
	}

	By Wpsps = By.xpath("//img[@alt='AL FARDAN EXCHANGE']");

	public void Wpsps_Links() throws IOException {
		String url;
		int i = 1;
		int count = 1;
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));
		try {
			csvPrinter.printRecord("Links in WPS and Payroll Services.");
