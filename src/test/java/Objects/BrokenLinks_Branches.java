...
public class BrokenLinks_Branches {

	WebDriver driver; 
	CSVPrinter csvPrinter;
	public BrokenLinks_Branches(WebDriver driver, CSVPrinter csvPrinter) {
		this.driver = driver;
		this.csvPrinter = csvPrinter;
	}

	By Branches = By.xpath("//img[@alt='AL FARDAN EXCHANGE']");

	public void Branches_Links() throws IOException {
		String url;
		int i = 1;
		int count = 1;
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));
		try {
			csvPrinter.printRecord("Links in AlphaClub.");
