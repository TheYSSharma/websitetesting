...
public class PPC_Classic {
	WebDriver driver; 
	CSVPrinter csvPrinter;
	public PPC_Classic(WebDriver driver, CSVPrinter csvPrinter) {
		this.driver = driver;
		this.csvPrinter = csvPrinter;
	}

	By Ppc = By.xpath("//img[@alt='AL FARDAN EXCHANGE']");

	public void Ppc_Links() throws IOException {
		String url;
		int i = 1;
		int count = 1;
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));
		try {
			csvPrinter.printRecord("Links in PrePaid Card Classic Page");
