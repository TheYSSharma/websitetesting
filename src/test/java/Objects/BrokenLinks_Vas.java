...
public class BrokenLinks_Vas {

	WebDriver driver; 
	CSVPrinter csvPrinter;
	public BrokenLinks_Vas(WebDriver driver, CSVPrinter csvPrinter) {
		this.driver = driver;
		this.csvPrinter = csvPrinter;
	}

	By Vas = By.xpath("//img[@alt='AL FARDAN EXCHANGE']");

	public void VasLinks() throws IOException {
		String url;
		int i = 1;
		int count = 1;
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));
		try {
			csvPrinter.printRecord("Links in Broken Exchange Page");
